...
const builtInCommands = [
    ...
    { command: '/wifipass', description: 'Tampilkan kata sandi untuk jaringan WiFi.', icon: <WifiIcon className="w-5 h-5 mr-3 text-green-300"/>, usage: 'Contoh: /wifipass NAMA_WIFI' },
    ...
    { command: '/buatppt', description: 'Buat presentasi PowerPoint.', icon: <FileSlideIcon className="w-5 h-5 mr-3 text-orange-400"/>, usage: 'Contoh: /buatppt rencana bisnis Q3' },
    { command: '/createpresentation', description: 'Buat presentasi PowerPoint dari deskripsi.', icon: <FileSlideIcon className="w-5 h-5 mr-3 text-orange-400"/>, usage: 'Contoh: /createpresentation Rencana Peluncuran Produk' },
